...
const PATHS = {
  ...
  chat: (
    <>
      ...
      <path d="M7.5 10h9M7.5 13h6" strokeOpacity=".6" />
    </>
  ),
  up: <path d="M12 19V5M6 11l6-6 6 6" />,
  /* Ползунки, а не шестерёнка: круг с лучами в этой обводке читается как солнце,
     а солнце в шапке уже занято переключателем темы. */
  settings: (
    <>
      <path d="M3.5 8.5h8.3M18.2 8.5h2.3M3.5 15.5h2.3M12.2 15.5h8.3" />
      <circle cx="15" cy="8.5" r="3.2" />
